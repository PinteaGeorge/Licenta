...
export class MembersService {
  ...
  getMembers(userParams: UserParams) {
    ...
    let params = getPaginationHeaders(userParams.pageNo, userParams.pageSize);
  ...
  getMember(username: string): Observable<Member>{
    ...
    return this.http.get<Member>(this.baseUrl + 'users/getmemberprofile', {params: params});
  }

  updateMember(member: Member){
    return this.http.put(this.baseUrl + 'users/updatememberprofile', member)
      .pipe(map(() => {
  ...
  getLikes(predicate: string, pageNo, pageSize){
